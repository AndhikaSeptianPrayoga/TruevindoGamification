  ...
  return (
    <div className="page-shell min-h-screen bg-corporate text-ink">
      ...
      <div className="mx-auto flex min-h-screen max-w-7xl flex-col gap-8 px-6 py-8 lg:px-10">
        ...
        <footer className="relative mt-2 flex flex-col items-center gap-4 overflow-hidden rounded-[32px] border border-slate-800/80 bg-gradient-to-r from-slate-950 via-slate-900 to-slate-950 px-6 py-6 shadow-[0_28px_80px_rgba(2,6,23,0.34)]">
          <div className="absolute inset-x-10 top-0 h-px bg-gradient-to-r from-transparent via-white/35 to-transparent" />
          <div className="rounded-[28px] border border-white/12 bg-black/55 px-6 py-5 shadow-[inset_0_1px_0_rgba(255,255,255,0.08),0_18px_40px_rgba(0,0,0,0.28)]">
            <div className="flex items-center gap-6">
            <img src={truevindoLogo} alt="Truevindo" className="h-9 w-auto object-contain md:h-11" />
            <span className="h-9 w-px bg-white/20" aria-hidden />
            <img src={gimflyLogo} alt="Gimfly Studio" className="h-9 w-auto object-contain md:h-11" />
            </div>
          </div>
          <p className="text-center text-xs uppercase tracking-[0.25em] text-slate-100/90">
